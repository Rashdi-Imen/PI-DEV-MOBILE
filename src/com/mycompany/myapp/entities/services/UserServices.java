...
//    private ConnectionRequest req;
    ...
    boolean result;
     ...
     public boolean RegisterAction(String email ,String password,String password_confirmation,String nom,String prenom,String tel,String adresse) {
        ...
        String url = Statics.BASE_URL + "user/signup"+ "?email="+email+"&password="+password+"&confirm_password="+password_confirmation+"&nom="+nom+"&prenom="+prenom+"&tel="+tel+"&adresse="+adresse;
